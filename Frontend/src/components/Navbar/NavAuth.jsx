      ...
      <div className="px-2 mx-auto">
        <div className="flex items-center justify-end h-16">
          <div className="relative ">
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-[184px] bg-gray-800 rounded-md shadow-lg ring- ring-black ring-opacity-5 transition ease-in-out duration-300 border border-gray-700 z-10">
                <div
                  className="py-1"
                  role="menu"
